      ...
      <Layout title={"Immediate Burial Services"} >
        <div className="container">
          ...
          <div className="push-right">
            ...
            <span className="bold">$5,195.00</span>

            <h6>Church Service*</h6>
            <span className="bold">$5,225.00</span>
            ...
            <span className="bold">$465.00</span>
          </div>
          ...
          <p>Direct Cremation with Memorial Service:
                Staff for memorial service, register book, memorial folders, acknowledgement cards, office work, cremation casket and crematory charge, use of funeral home and equipment and service of assistants, service vans to cemetery. (Includes a plastic utility urn.) - <span className="bold">$3,390.00</span></p>
          ...
          <p>Direct Cremation with Memorial Service (One Funeral Director):
                ...
                - <span className="bold">$2,780.00</span></p>
          ...
          <p> Direct Cremation with Graveside Service/Assisted Family Arranged Memorial Service:
            Service at local cemetery (No registry book or memorial cards).  Funeral Director (prior to memorial service) to assist with transfer and arrangements of urn setting, flowers, register book, pictures, etc., at memorial service site. (Includes a plastic utility urn.)
              - <span className="bold">$1,940.00</span></p>
          ...
          <ul className="disc-list">
            ...
            <li>Coroner fee if applicable ($25.00 - $50.00)</li>
          </ul>
        </div>
      </Layout>
    );
