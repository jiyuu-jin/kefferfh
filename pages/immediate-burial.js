    ...
    return (
      <Layout title={"Immediate Burial Services"} >
        <div className="container">
          ...
          <p> Service at Funeral Home or Church *¹ (includes flannel covered casket): <span className="bold">$3,545.00</span></p>
          ...
          <p>As above with limited family requirements for funeral home staff and no cemetery procession.  Service other than funeral home (No flower or service car)*¹ including flannel covered casket.: <span className="bold">$2,670.00</span>
          ...
          <p>Same as above with service at local cemetery (No register book or memorial cards) flannel casket: - <span className="bold">$2,300.00</span>
          ...
          <p>Limited professional service and care of the body, removal from place of death, office  and transportation expense and flannel (Without any attendant rites or ceremonies)
              Immediate Burial including flannel covered casket. (must be paid at or prior to time of need): - <span className="bold">$2,040.00</span>
